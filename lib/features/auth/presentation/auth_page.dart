...
class _RegisterPageState extends ConsumerState<RegisterPage> {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Create Account')), body: SafeArea(child: Center(child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 480), child: ListView(padding: const EdgeInsets.fromLTRB(24, 28, 24, 36), children: [
    ...
    const SizedBox(height: 28), FilledButton(onPressed: _loading ? null : _create, style: FilledButton.styleFrom(minimumSize: const Size.fromHeight(56)), child: const Text('Create Account\nアカウントを作成', textAlign: TextAlign.center)),
